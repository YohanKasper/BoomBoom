...
offer = Offer.create!(
  ...
  date: "2020-08-17",
  category: "Drinks"
  image: URI.open("https://images.unsplash.com/photo-1542634093-e0198d4d1e46?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1650&q=80")
)
offer.image.attach(io: file, filename: 'nes.png', content_type: 'image/png')
